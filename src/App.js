        ...
        <div className="header-content">
          <div className="header-top">
            <div className="header-github">
              <a 
                href="https://github.com/Piyush-dhami-9/ALGO-vision.git" 
                target="_blank" 
              ...
              <a 
                href="https://github.com/Piyush-dhami-9/ALGO-vision.git/stargazers" 
                target="_blank" 
                rel="noopener noreferrer"
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <div className="github-links">
              <a 
                href="https://github.com/Piyush-dhami-9/DSA-visual" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://github.com/Piyush-dhami-9/ALGO-vision/stargazers" 
                target="_blank" 
                rel="noopener noreferrer"
                className="star-link"
              >
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-links">
            <a 
              href="https://github.com/Piyush-dhami-9/" 
              target="_blank" 
              rel="noopener noreferrer"
            >
              Made by piyush
            ...
            <a 
              href="https://github.com/Piyush-dhami-9/ALGO-vision.git/issues" 
              target="_blank" 
              rel="noopener noreferrer"
            >
              Report Issues
            ...
            <span className="separator">|</span>
            <a 
              href="https://github.com/Piyush-dhami-9/ALGO-vision.git/blob/main/README.md" 
              target="_blank" 
              rel="noopener noreferrer"
            >
              Documentation
